...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "../Content/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "../Content/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			...
			case "theme-5":
			case "theme-6":
				$(".navbar-brand img").attr("src", "../Content/images/logo2.png");
				break;
	...
	$('#reset-layout').on('click', function() {
		...
		$('#skin_color').attr("href", "../Content/css/themes/lyt1-theme-1.css");
		switcheryHandler();
		settingsHandler();
		setTimeout(function() {
